...
const DesktopNav = () => {
    return (
        <div className='w-full h-20 md:flex hidden flex-row justify-between items-center text-black px-8 py-2 font-sans'>
            <img src={"https://res.cloudinary.com/de7hlbfce/image/upload/f_auto,q_auto/v1/Froker/zfknckgkzlafeqpgwy02"} alt='logo' className='' />
            <div className='h-full flex flex-row items-center text-orange-500 text-[1.3rem] gap-4 mr-8 font-normal'>
                ...
                <a href='/' className='hover-underline-animation'>Discover Broker</a>
            </div>
        </div>
    )
}
    ...
    return (
        <>
            <div className='w-full h-20 md:hidden flex flex-row justify-between items-center text-black px-8 py-2 font-sans'>
                <img src={"https://res.cloudinary.com/de7hlbfce/image/upload/f_auto,q_auto/v1/Froker/zfknckgkzlafeqpgwy02"} alt='logo' className='' />          
                <button onClick={() => setOpen(!open)} className='text-orange-500 text-[1.3rem] font-normal'>
                    <img src={open ? close : menu } alt="" className='w-8 h-8'/>
                </button>
            </div>
            <div className={`fixed z-50 top-0 left-0 w-screen flex flex-col justify-center items-center ${ open ? " origin-left duration-700 bg-white overflow-hidden" : "-translate-x-[100%] origin-center duration-700" } touch-none mt-20`}>
